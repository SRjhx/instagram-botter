...
def __main__:
 ...
 print("");print("[1] - Likes ");print("500");print("[2] - Views ");print("233");print("[1] - Followers ");print("");
   choose=input('> ')
       if choose=="1":
       ...
       req.url("https://www.instagram.com/stories/johanxel_/3407858524267310525?utm_source=ig_story_item_share&igsh=OXJqODg1ZW84aXRy")
       req.new accounts 
             def __gen__:
